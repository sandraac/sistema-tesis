            ...
            <div class="text-center">
                <div class="row mt-3 mb-4 ml-5 mr-5">
                    <div class="col-md-12 col-sm-12 col-12"> 
                        <input type="text" class="form-control" placeholder="Introduzca el código de barras del producto" value="" required>
                    </div>
                </div>
                <button type="button" class="btn btn-theme">Buscar</button>
            </div>              
        </div>
     </div>
</div>
