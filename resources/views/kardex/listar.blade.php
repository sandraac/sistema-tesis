...
@section('contenido')
<h5 class="mb-0" ><strong><i class="fa fa-reply"> </i> Kardex general</strong></h5>
<span class="text-secondary">En el módulo KARDEX puede ver los movimientos y costos de entradas - salidas de productos. Además, puede ver información detallada de los movimientos específicos de un producto por cada mes.</span>
<div class="row mt-3">
    <div class="col-sm-12">
        <!--Summernote editor with div element-->
        <div class="mt-2 mb-2 button-container">
            <div class="text-center">
                <span class="p-2"><a class="text-info" href="#"><i class="fa fa-search"> </i> Kardex General</a></span>
                <span class="p-2"><a class="text-info" href="#"><i class="fa fa-reply"> </i> Buscar kardex</a></span>
                <span class="p-2"><a class="text-info" href="#"><i class="fa fa-reply"> </i> Kardex por producto</a></span>
            </div>                
